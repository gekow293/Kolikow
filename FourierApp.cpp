...
// FourierApp.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(FourierApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
	//ON_COMMAND(ID_TEST_INAPPCLASS, &CWinApp::AppMessageCommand)
	//ON_COMMAND(ID_TEST_INBOTHCLASS, &CWinApp::AppMessageCommand)
...
// Единственный объект FourierApp

FourierApp theApp;


// Инициализация FourierApp

BOOL FourierApp::InitInstance()
{
